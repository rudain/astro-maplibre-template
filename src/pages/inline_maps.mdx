...
import jamaicabaychangesone from "/images/jamaicabaychangesone.jpg"


<PageLayout title={SITE.title} description={SITE.description}>

    <Container>
    # jamaica bay, as transformed
    ...
    <MapLibre
        ...
        containerstyle="width: 100%; height: 456px"
    />


    <p>Jamaica Bay in 1877, before the dredging project truly began..</p>

    <p>Jamaica Bay Port Plan of 1907. Although the port didn't come to be, this project drastically affected the topography of the bay.</p>   

    <p>Land change from 1877 to 2024</p>

    <p>Land lost from 1877 to 2024</p>
   
    <img src={fiskImg} alt="Description of Jamaica Bay changes" />

    image test one and two
    <img src={jamaicabaychangesone} alt="Changes over time of Jamaica Bay" />

    <img src="/images/jamaicabaychangesone.jpg" alt="alt text test" />
