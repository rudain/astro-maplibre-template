...
import jamaicabaychangesone from "public/jamaicabaychangesone.jpg"
...
<PageLayout title={SITE.title} description={SITE.description}>
   ...
   comparison of jamaica bay from 1877 to 2024
<img src={jamaicabaychangesone} alt="map comparing jamaica bay from 1877 to 2024"/>

    land lost from 1877 to 2024
    ...
    Plan for converting Jamaica Bay into a port. Jamaica Bay Improvement Commission, 1907.
