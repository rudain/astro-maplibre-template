...
import jamaicabaychangesone from "../assets/img/jamaicabaychangesone.jpg"
...
<PageLayout title={SITE.title} description={SITE.description}>
    ...
    <p>Jamaica Bay in 1877</p>
    <p>Land lost from 1877 to 2024</p>



    <img src={jamaicabaychangesone} alt="Description of Jamaica Bay changes" />
